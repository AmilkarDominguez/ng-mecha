...
📎 **Antes de generar código**, lee también:
- [`CONTEXT.md`](./CONTEXT.md) — stack, arquitectura, patrones, convenciones de código.
- [`entities.md`](./entities.md) — esquema de base de datos (tablas, enums, RLS).
