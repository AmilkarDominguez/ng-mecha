...
@Component({
  selector: 'app-income-register-table',
  imports: [
    CurrencyPipe,
    DatePipe,
    MatTableModule,
  ...
  templateUrl: './income-register-table.html',
  styleUrl: './income-register-table.scss',
})
export class IncomeRegisterTable implements AfterViewInit {
